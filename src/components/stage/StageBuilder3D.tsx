...
const SPECS: Record<Kind, Spec> = {
  ...
  img_0838:     { label: "IMG_0838",         category: "sound",  size: [0.80, 1.20, 0.90], stackable: true,  hint: "Dvojitá W-bin basová bedna (foto IMG_0838)", defaultLabel: "IMG_0838" },
  img_0839:     { label: "IMG_0839",         category: "sound",  size: [0.85, 1.30, 0.95], stackable: true,  hint: "Basová skříň se žlutou výztuhou (foto IMG_0839)", defaultLabel: "IMG_0839" },
  img_0841:     { label: "IMG_0841",         category: "sound",  size: [1.60, 1.40, 1.00], stackable: true,  hint: "Quad basový stack (foto IMG_0841)", defaultLabel: "IMG_0841" },
  img_0842:     { label: "IMG_0842",         category: "sound",  size: [0.75, 1.80, 0.85], stackable: true,  hint: "Vysoký scoop stack (foto IMG_0842)", defaultLabel: "IMG_0842" },
  img_0843:     { label: "IMG_0843",         category: "sound",  size: [1.80, 1.60, 0.85], stackable: true,  hint: "Repro stěna s hex mřížkou (foto IMG_0843)", defaultLabel: "IMG_0843" },
